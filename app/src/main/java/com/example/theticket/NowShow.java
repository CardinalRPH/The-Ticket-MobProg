...
public class NowShow extends AppCompatActivity {
    ...
    private ActivityNowShowBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding =ActivityNowShowBinding.inflate(getLayoutInflater());
        ...
        final ImageAdapter adapter = new ImageAdapter(imageList, titles, thecode, codeimg, this);
