...
import com.example.theticket.databinding.ActivityUpShowDetailBinding;
...
public class UpShowDetail extends AppCompatActivity {
    private ActivityUpShowDetailBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUpShowDetailBinding.inflate(getLayoutInflater());
    ...
    private void setupAction() {
        binding.backtck.setOnClickListener(view -> {
            Intent intent = new Intent(UpShowDetail.this,Upshow.class);
